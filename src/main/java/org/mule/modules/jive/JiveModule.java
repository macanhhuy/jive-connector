    ...
    public void init() 
     {
    	 if(facade == null)
    	 {
    		 ...
    		 facade.init();
    		 this.facade = JiveModuleAdaptor.getFacadeProxy(facade);
    	 }
    	 facade.init();
	}

     @Processor
	public Map<String, Object> execute(Operation op,
			 @Optional Map<String, Object> entity, @Optional String id) {
    	 if(entity != null){
...
//     @Processor
//	public Map<String, Object> execute(String uri, String id) {
//		return facade.execute(uri, id);
//	}



     @Processor
	public Map<String, Object> delete(EntityType type, String id) {
